...
_doz2.default.use(function (Doz) {
    Doz.mixin({
        slideDeserialize: function slideDeserialize(str) {
            return _he2.default.decode(str);
        },
        slideSerialize: function slideSerialize(str) {

            if (Array.isArray(str)) str = Object.assign([], str).join(SEPARATOR);

            return _he2.default.encode(str, {
...
;(function (root) {
	...
	// like the following:
	if ( true && _typeof(__webpack_require__(1)) == 'object' && __webpack_require__(1)) {
